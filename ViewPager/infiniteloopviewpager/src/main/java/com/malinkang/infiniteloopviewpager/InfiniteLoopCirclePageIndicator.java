...
public class InfiniteLoopCirclePageIndicator extends View implements PageIndicator {
    ...
    public InfiniteLoopCirclePageIndicator(Context context) {
        this(context, null);
    }

    public InfiniteLoopCirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
    }

    public InfiniteLoopCirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
    ...
    public int getRealCount() {
        if (mViewPager.getAdapter() instanceof InfiniteLoopPagerAdapter) {
            return ((InfiniteLoopPagerAdapter) mViewPager.getAdapter()).getRealCount();
        } else {
