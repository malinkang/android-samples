...
public class GuideActivity$$ViewInjector {
  public static void inject(Finder finder, final com.mamating.activity.GuideActivity target, Object source) {
    ...
    view = finder.findById(source, 2131034176);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131034176' for field 'mViewPager' was not found. If this view is optional add '@Optional' annotation.");
    }
